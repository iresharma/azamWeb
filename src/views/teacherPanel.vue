    ...
    <div style="overflow: hidden" class="columns">
        <div class="column is-2" style="overflow: hidden; background-color: #ffdd57;">
            <ul style="margin: 20px; text-align: left">
                <li @click="change(0)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li @click="change(1)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li @click="change(2)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li @click="change(3)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li @click="change(4)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li @click="change(5)" class="aim" v-if="type == 'admin'" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li @click="change(6)" class="aim" v-if="type == 'admin'" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
