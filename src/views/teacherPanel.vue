<template>
    <div style="overflow: hidden" class="columns">
        <div class="column is-2" style="overflow: hidden; background-color: #ffdd57;">
            <ul style="margin: 20px; text-align: left">
                <li id="li0" @click="change(0)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px; background: #ffcc46">
                ...
                <li id="li1" @click="change(1)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li id="li2" @click="change(2)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li id="li3" @click="change(3)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li id="li4" @click="change(4)" class="aim" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li id="li5" @click="change(5)" class="aim" v-if="type == 'admin'" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
                ...
                <li id="li6" @click="change(6)" class="aim" v-if="type == 'admin'" style="color: black; padding: 5px; margin: 10px 0 10px 0; font-size: 20px">
...
export default {
    ...
    methods: {
        change(ind) {
            this.comp = ind;
            for(var i = 0; i < 7; i++) {
                this.$el.querySelector('#li'+i).style.background = 'transparent';
            }
            this.$el.querySelector('#li' + ind).style.background = '#ffcc46';
        }
    }
}
</script>