                ...
                <div class="column is-9 is-offset-one-quarter">
                    ...
                    <div>
                        <div class="file has-name">
                            ...
                            <input class="input" v-model="pdf.subtitle" placeholder="Pdf description" type="text">
                            ...
                            <a @click="onUploadpdf" class="button is-rounded is-warning is-medium">Upload pdf</a>
                    </div>
                </div> 
            </div>
                ...
                <div class="column is-9">
                    ...
                    <div>
                        <div class="file has-name">
                            ...
                            <a @click="onUploadvideo" class="button is-rounded is-warning is-medium">Upload video</a>
                    </div>
            </div> 
