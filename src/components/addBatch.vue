<template>
    <div class="box" style="margin: 25px; text-align: left; height: 100vh">
        ...
        <h1 style="font-weight:600; font-size: 3vh; ">Create batch<br>
            <small class="text-muted" style="font-size: 2vh">Setup a new batch and generate join code</small>
        </h1>
        <div class="columns" style="margin-top: 20px;">
            <div class="column">
                <strong>Batch info</strong>
                <div v-if="!show">
                    <input type="text" v-model="batchName" placeholder="Batch name" class="input">
                    <input type="number" v-model="nTotal" placeholder="Number of students" class="input">
                </div>
                <div v-else>
                    <input disabled type="text" v-model="batchName" placeholder="Batch name" class="input">
                    <input disabled type="number" v-model="nTotal" placeholder="Number of students" class="input">
                </div>
                <span v-if="showerr" style="color: red">All fields are mandatory</span><br>
                <a @click="makeToken" style="position: relative; left: 60%" class="button is-info is-rounded">Generate join code.</a>
...
export default {
    ...
    methods: {
        makeToken() {
            ...
            else if(this.show == false && this.batchName == '' && this.nTotal == 0) {
                this.showerr = true;
            }
         },
         write() {
