<template>
  <nav
    style="z-index: 4; position: sticky; top: 0px"
    class="navbar navbar-light navbar-expand-md navigation-clean-button"
  >
    <div class="container">
      <span style="font-size: 30px;border-bottom: 2px dashed red"
        >Azam Anzari</span
      >
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="nav navbar-nav mr-auto">
          <li class="nav-item" role="presentation">
            <a class="aim nav-link" @click="$router.push('/')">Home</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="aim nav-link" @click="$router.push('/notes')">Notes</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="aim nav-link" @click="$router.push('/videos')">Videos</a>
          </li>
          <li class="nav-item" v-if="type == 'student'" role="presentation">
            <a class="aim nav-link" @click="$router.push('/class')"
              >Live Class</a
            >
          </li>
          <li
            ...
            role="presentation"
          >
            <a class="aim nav-link" @click="$router.push('/panel')"
              >Teacher Panel</a
            >
          </li>
        </ul>
